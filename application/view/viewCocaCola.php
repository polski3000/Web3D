           ...
           <div id="myCarousel" class="carousel slide" data-ride="carousel">
              ...
              <div class="carousel-inner">
                <div class=" carousel-item active">
                  <img src="../application/assets/images/dCoke.jpg" alt="banner1">
                </div>

                <div class="carousel-item">
                  <img src="../application/assets/images/costa.jpg" alt="banner2">
                </div>

                <div class="carousel-item">
                  <img src="../application/assets/images/appletiser.jpg" alt="banner3">
                  </div>

                  <div class="carousel-item">
                  <img src="../application/assets/images/fanta.jpg" alt="banner4">
                  </div>
                </div>
                </div>
              </div>
            ...
            <div class="row">
                  ...
                  <div class="col-sm-4">
                    <a href="../application/assets/images/renderImages/fanta.jpg" data-fancybox data-caption="My 3D Coke Can Render">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/fantaBrand.jpg" alt="Coca Cola">
                    </a>
                  </div>
            </div>
            <div class="row">  
                   <div class="col-sm-4">
                    <a href="../application/assets/images/renderImages/apple.jpg" data-fancybox data-caption="My 3D Sprite Bottle Render" class="img-narrow">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/appletiserBrand.jpg" alt="Sprite">
                    </a>
                  </div>
            <div class="col-sm-8">
                      <div class="card">
            ...
            <div class="row">     
                  ...
                  <div class="col-sm-4">
                  <a href="../application/assets/images/renderImages/dCoke.jpg" data-fancybox data-caption="My 3D Pepper Cup Render" class="thumbnail">
                            <img class="card-img-top img-fluid img-thumbnail" src="../application/assets/images/dietCoke.jpg" alt="Dr Pepper">
                  </a>
                  </div>
            </div>
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/fantaA.x3d" > </inline>
                                    </transform>
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/apple.x3d"> </inline>
                                    </transform>
                                    <transform>
          ...
          <div id="interaction" class="row" style="display:none;">
                ...
                <div class="col-sm-4">
                    <div class="card text-left">
                      ...
                      <div id="audio" class="card-body"> <!--audi-->
                    <div class="card-Title x3dCamera_Subtitle drinksText">
                      <h3>Audio</h3>
                    </div>                            
